\autsection{High Directional Link}{Nissopoulos Ioannis}
...
\begin{figure}[htb]
    ...
    \subfloat[The basic components of a log periodic dipole array. The forward direction is to the left in this sketch]{
        \includegraphics[width=.48\linewidth]{figures/Yannis/log2.jpg}
        \label{log}
    }
\end{figure}
...
\begin{figure}[htb]
    ...
    \subfloat[Radiation pattern of helical antenna when operating in axial mode\cite{helix}]{
        \includegraphics[width=.48\linewidth]{figures/Yannis/H2.png}
        \label{helix_pat}
    }
