...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{LPDA.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{lpda23.jpg}
    \caption{Foldable wire LPDA specifications by ALARIS antennas.}
    \label{LPDA2}
\end{figure}
...
\subsection{MATLAB code for different antenna designs}
\label{matlab}

\subsubsection{LPDA design}
...
\subsubsection{Helical antenna design}
...
\subsubsection{Parabolic antenna design}
