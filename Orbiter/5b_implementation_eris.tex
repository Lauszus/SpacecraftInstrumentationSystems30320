...
\subsection*{Imaging System Requirements}
...
Below on Fig.\ref{fig:eleprotflux}, expected electron and proton fluxes are presented for one year duration trajectory. Estimated flux was calculated based on the final orbit selection of the orbiter.
...
For an effective shielding against radiation, three levels of protection are advised. 
% Use existing aerospace radiation hardened parts rated at 300 krad or less
 % VAULT
...
\cline{1-3}    \textbf{(mm)} & \textbf{(mils)} & \textbf{(g cm2)} & \multicolumn{1}{c|}{\textbf{Electrons}} & \multicolumn{1}{c|}{\textbf{Protons}} & \textbf{strahlung} & \multicolumn{1}{c|}{\textbf{Total (krad)}} \bigstrut\\
  ...
  \caption{Total ionizing dose as a function of shield thickness, SPENVIS (SHIELDOSE)}
\end{table}%
