...
\makeatletter
\newcommand{\addauthorbelowheading}[2]{%
	{\parindent0pt\vspace*{#2}%
...
%	\vfill
    ...
    \begin{center}
        \topskip0pt
        \vspace*{\fill}
        \large\textsc{Editor: Kristian Sloth Lauszus}
        \vspace*{\fill}
	\end{center}
