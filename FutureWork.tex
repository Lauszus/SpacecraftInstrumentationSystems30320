...
In order to select the right anchoring system, we need further information on the ice nature. Moreover, some further work needs to be done in order to determine the internal organisation of the vessel, such as the placement of instruments, or the sample distribution system. Similarly, some work still needs to be done on all the necessary mechanisms for sample taking and up-concentration systems.
Finally, sizing and determining exactly the properties and capabilities of the radar at the bottom of the penetrator, used to examine the ice-column beneath the penetrator, is still to be done.
