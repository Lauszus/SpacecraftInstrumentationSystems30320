...
\subfloat[Thickness of the titanium wall in function of the outer radius of the submarine]{
\includegraphics[width=0.48\textwidth]{figures/Paul/Thickness.pdf}
\label{wallthickness}
}
\subfloat[Weight of the spherical submarine in function of its outer radius]{
\includegraphics[width=0.48\textwidth]{figures/Paul/SphereWeight.pdf}
\label{sphereweight}
}
\end{figure}
