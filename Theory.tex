...
In this chapter some of the different theories about the moon will be presented. This includes some of the general theories about the moon environment and its characteristics.
...
\subsubsection{Current Knowledge}
...
\input{TemperatureConvection}

\autsection{Ice Losses}{Nissopoulos Ioannis}\label{sec:ice_losses}
...
\input{Orbiter/2_theory}

%added theory
\input{Orbiter/autonomous_landing_selection}
