...
\autsubsubsection{Buoyancy}{Ricard Grove}
...
\begin{equation}
F_{gravity} = F_{buoyancy} \quad \rightarrow \quad m_{penetrator}g_{Europa} = \rho_{fluid}g_{Europa} V_{immersed}   \quad \rightarrow \quad m_{penetrator} = \rho_{fluid} V_{immersed}
\end{equation}
First of all we see that the gravity of Europa cancels out in both equations. 
It is desired to get an estimate of the buoyancy and hereby some assumptions has to be made. First of all the mass of the penetrator is in our mission straw man set to be maximum $\SI{180}{kg}$. If the mass of the penetrator increases we would in the last end not need as high a volume to equal out the gravitation. Secondly the gravitational acceleration is set to be $\SI{1.314}{\frac{m}{s^2}$, and has been calculated by \begin{equation}
g = \frac{GM}{r^2}
\end{equation} 
where $G = \SI{6.67\cdot 10^{-11}}{\frac{m^3}{s^2 kg}}$ is the gravitational constant, $M = \SI{4.8\cdot 10^{22}}{kg}$ is the mass of Europa and $r = \SI{1560.8}{km}$ is the radius of Europa.  We see that the further the penetrator melts its way down through the ice the radius decreases. The mass distribution will also change since now there will be mass above you which will pull you in that direction, but on the other hand you will be closer to the mass on the other side of the planet. Therefore the change in gravitational acceleration depends on the distribution of the mass on Europa, and especially how dense the core is which in this case is unknown. 
