...
\subsection{RTG design (Ricard)}

After looking at the different materials, Plutonium is radioactive material that is going to be used. With the half-life of 87.7 years it is optimal to a mission that is going to take several years. 




•	What material is used? We will assume plutonium, half-life of 87.7 years \\

•	How much power do we need? 2kW for melting and 150W for electrical power \\

•	How big should the RTG then be? How long could it provide this power (with that mass) \\

•	Radiation should be absorbed (there are three kinds of radiation: radiowaves, alpha, beta, nutrions (the dangerous ones)) \\
