...
\autsubsection{Rotary drilling}{Søren Jeppesen}
...
\autsection{RTG design}{Ricard Grove}\label{sec:rtg}

\autsection{Pressure Distribution on Europa}{Ricard Grove}\label{sec:Pressure}
