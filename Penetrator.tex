...
\end{aligned}
\end{equation}
This means that for each Kelvin the temperature will increase, 14.05 W is needed. Since the thermal energy for the melting is 2kW the temperature change will be: 
...
\autsubsection{Explosive Bolts}{Ricard Grove}
...
\input{Submarine}
\autsubsection{Cylindrical submarines}{Ricard Grove}
...
\autsection{Detection of Depth and End of Ice Column}{Jean-Paul Breuer}
...
\autsection{Relay Systems}{Jean-Paul Breuer}
